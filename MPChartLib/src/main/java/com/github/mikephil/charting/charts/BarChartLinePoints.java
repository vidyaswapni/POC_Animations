...
import com.github.mikephil.charting.renderer.BarChartLineRenderer;
 ...
 */
public class BarChartLinePoints extends BarLineChartBase<BarData> implements BarDataProvider {
    ...
    public BarChartLinePoints(Context context) {
        super(context);
    }

    public BarChartLinePoints(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BarChartLinePoints(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new BarChartLineRenderer(this, mAnimator, mViewPortHandler);
