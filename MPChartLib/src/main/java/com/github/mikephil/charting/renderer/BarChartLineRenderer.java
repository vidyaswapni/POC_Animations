...
public class BarChartLineRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    public BarChartLineRenderer(BarDataProvider chart, ChartAnimator animator,
    ...
    public void drawValues(Canvas c) {
        ...
        if (isDrawingValuesAllowed(mChart)) {
            ...
            final float valueOffsetPlus = Utils.convertDpToPixel(10.5f);
            float posOffset = 0f;
            float negOffset = 0f;
    ...
    private class DataSetImageCache {
         ...
         * @return
         */
        protected boolean init(IBarDataSet set) {
         ...
         */
        protected void fill(IBarDataSet set, boolean drawCircleHole, boolean drawTransparentCircleHole) {
